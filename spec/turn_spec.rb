...
RSpec.describe Turn do
  ...
  describe '#winner' do
    describe 'a :basic turn type' do
      it 'returns the player with the higher ranking card' do
        card1 = Card.new(:diamond, 'Queen', 12)
        card2 = Card.new(:spade, '3', 3)
        card5 = Card.new(:heart, '8', 8)
        card8 = Card.new(:diamond, '2', 2)
    ...
    describe 'a :war turn type'
    describe 'a :mutalluy_assured_destruction turn type'
  end
  ...
  it "moves to spoils_of_war" do
    ...
    expect(turn.type).to eq(:mutually_assured_destruction)
    expect(turn.winner).to eq("No winner")
    expect(turn.pile_of_cards).to eq([])
  end

  it "moves to award_spoils" do
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
    card3 = Card.new(:heart, '9', 9)
    card4 = Card.new(:diamond, 'Jack', 11)
